module.exports = [
    {title:'调试模块',class:'icon-signal',list:[    {title:'核心流程实时调用曲线图',url:'/realtimeGraph.html?chartList=realTimeLcuSumChart'},
                                                    {title:'核心流程历史调用曲线图',url:'/historyComPareGraph.html?chartList=historyLcuSumChart&isWhere=true'},
                                                    ...
                                                    {title:'历史超时明细',url:'/historyTopDetail.html?chartList=historyTopDetailList'},
                                                    {title:'异常流程分析',class:'icon-tasks',list:[],url:'/flowInfoAnalysis.html?flowId=/lcuErrorAnalysis.html'}
                     ]
    }
]
